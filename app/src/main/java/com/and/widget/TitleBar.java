...
public class TitleBar extends FrameLayout {
    ...
    private void initUI(Context context) {
        ...
        leftButton= (Button) findViewById(R.id.left_bt);
        rightButton= (Button) findViewById(R.id.right_bt);
    ...
    public void initTitleBarInfo(String title,String leftText,String rightText){
        //设置标题
    ...
    public void setTitleBarBackgroundColor(int colorRes) {
        if (colorRes == 0) {
            container.setBackgroundResource(R.color.base_color);
        } else {
            container.setBackgroundColor(colorRes);
        }
