...
//        titleBar.initTitleBarInfo(null,-1,R.drawable.u11,null,"X 取消");
        ...
        lv_doctor2.setAdapter(new Doctor2Adapter());
    }

    /**
     * GridView的适配器
     */
    private class Doctor2Adapter extends BaseAdapter {
        @Override
        public int getCount() {
            return 4;
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(convertView!=null&&convertView instanceof RelativeLayout){
                ...
                view=View.inflate(Doctor2Activity.this,R.layout.item_doctor,null);
            }
            return view;
        }
        @Override
